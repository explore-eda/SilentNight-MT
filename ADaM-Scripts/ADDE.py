...
DE_path = '/Users/haoxiang/Desktop/SilentNight-MT/transformed_files/Transformed_DE.xlsx'
spec_path = '/Users/haoxiang/Desktop/SilentNight-MT/XYZ_ADaM_Spec_v1.xlsx'

passed_sheet_name = 'ADDE'

DE_data = pd.read_excel(DE_path, sheet_name='Sheet1')
spec_data = pd.read_excel(spec_path, sheet_name=passed_sheet_name)

transformed_data = pd.DataFrame(index=DE_data.index)

transformed_data['STUDYID'] = DE_data['STUDYID']
...
domain_names = {passed_sheet_name: "Analysis Dataset of Device Events"}
required_columns = spec_data['Variable Name'].dropna().tolist()
